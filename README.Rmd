...
`r  badger::badge_custom('codecov', paste0(per_cov,'%25'), color = 'green', url = 'https://biogit.pri.bms.com/KSR/bmsconnectwidgets')`
<!-- badges: end -->
...
Please note that the icWGCNA project is released with a [Contributor Code of Conduct](https://contributor-covenant.org/version/2/0/CODE_OF_CONDUCT.html). 
